...
<form class="form-validate form-horizontal" id="feedback_form" method="get" action=""> 
                                  ...
                                  <input type="hidden" name="method" value="PATCH" />
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class="form-control name="name_client" type="text" value="{{ $client->name_client }}">
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cemail" class="control-label col-lg-2">E-Mail <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="cemail" type="email" name="email_client" value="{{ $client->email_client }}">
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="curl" class="control-label col-lg-2">Website</label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="curl" type="url" name="Website_client" value="{{ $client->Website_client }}">
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Phone Number  <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control" id="subject" name="Phone_client" minlength="5" type="text" value="{{ $client->Phone_client }}">
                                          </div>
                                      </div>                                      
                                      <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">Information</label>
                                          <div class="col-lg-10">
                                          <input class="form-control" id="subject" name="Phone_client" minlength="5" type="text" value="{{ $client->information_client }}">
